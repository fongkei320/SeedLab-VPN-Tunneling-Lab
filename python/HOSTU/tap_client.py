...
while True:
	...
	if True:
		...
		if ARP in ether and ether[ARP].op == 1 :
			arp = ether[ARP]
			newether = Ether( dst=ether.src, src="11:22:33:44:55:66", type=ether.type )
			newarp = ARP(op=2, psrc=arp.pdst, pdst=arp.psrc, hwsrc="11:22:33:44:55:66", 
			hwdst=arp.hwsrc, ptype=arp.ptype, hwlen=arp.hwlen, plen=arp.plen)
